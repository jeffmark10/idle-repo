...
const MIGRATION_FLAG_KEY = "RI_MIGRATED_V3";
...
const INITIAL_STATE = {
  ...
  stats: {
    ...
    stars: 0,
    starBaseUpgrades: 0,
    // Campos reativos da camada de Eternidade
    ap: 0,
    animalsCount: 0,
    labRP: 0,
  ...
  favoriteMacros: [],
  // Namespace reservado para features futuras
  future: {
    unity: {},
    minerals: {},
    tarot: {},
...
export function GameProvider({ children }) {
  const [gameState, setGameState] = useState(() => {
    // Executa limpeza de chaves legadas apenas uma vez
    ...
    if (saved) {
      try {
        ...
        return {
          ...
          future: { ...INITIAL_STATE.future, ...(parsed.future || {}) }
        };
      } catch (e) {
  ...
  // Persistência com debounce de 400ms para evitar gargalo de I/O
  useEffect(() => {
