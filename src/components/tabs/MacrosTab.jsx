...
import { 
  ...
  Search, Info, Zap, Trophy, ShieldAlert, 
  Clock, Play, Code2, Sparkles, BookOpen
} from "lucide-react";
...
export default function MacrosTab() {
  ...
  const MACRO_SUBTABS = [
    ...
    { id: "Minerais & Elementos", label: "Minerais & Elementos", icon: Sparkles },
    { id: "Singularidade", label: "Singularidade", icon: Code2 },
  ...
  return (
    <div className="space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="p-5 rounded-3xl bg-zinc-900/50 border border-zinc-800 space-y-3 font-mono">
              ...
              <div className="space-y-1 text-zinc-300 text-[11px]">
                ...
                <div>• <code>PolishPrestige() / RefinePrestige()</code>: Executa ações de minerais.</div>
      ...
      {/* ========================================================================= */}
      {/* LISTA DE MACROS COM BUSCA E CÓPIA */}
      {/* ========================================================================= */}
      {subSection !== "guide" && (
        <div className="space-y-4">
          ...
          <div className="relative w-full">
            ...
            <input
              ...
              placeholder="Buscar macro por nome, comando (ex: LoadDT, BreakInfinity) ou camada..."
            ...
            {filteredMacros.map((macro) => {
              ...
              return (
                ...
                >
                  ...
                  {/* Bloco de Código da Macro (Multi-linha Real) */}
                  <div className="space-y-2">
