...
import { 
  ...
  CheckCheck, Table, AlertTriangle, Search, Zap, Layers,
  Info, Clock, Compass, CheckCircle2, Trophy, Star, ShieldAlert
} from "lucide-react";
...
export default function DilationTab() {
  ...
  return (
    <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 pt-2 font-mono text-xs">
              ...
              <div className="p-3.5 rounded-2xl bg-zinc-950/90 border border-cyan-500/30 space-y-1">
                ...
                <p className="text-zinc-400 font-sans text-[11px] leading-relaxed">
                  ...
                  • <strong>DU2 (Renda DP):</strong> Multiplica sua renda de DP/s em x1.07 por nível (Compre durante farms de EP/SN).
                </p>
              </div>
      ...
      {/* ========================================================================= */}
      {/* 1. ÁRVORE ESPACIAL & BUILDS (DTP 1 A 48) */}
      {/* ========================================================================= */}
      {subSection === "tree" && (
        <div className="space-y-6">
