...
import { 
  ...
  CheckCheck, Table, Compass, AlertTriangle, Search
} from "lucide-react";
      ...
      <div className="p-6 sm:p-8 rounded-3xl bg-gradient-to-br from-cyan-950/40 via-zinc-900/70 to-zinc-950 border-2 border-cyan-500/30 shadow-2xl space-y-4">
        ...
        {isOverLimit && (
          <div className="p-3 bg-red-950/40 border border-red-500/40 rounded-2xl flex items-center gap-2 text-xs text-red-200 font-mono">
            ...
            <span>Atenção: Você alocou mais de 65 DTP ({totalDtpSpent} DTP). O jogo aceita no máximo 65 pontos alocados.</span>
          </div>
        )}
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
          ...
          <div className="relative w-full sm:w-64">
            ...
            <input
              ...
              placeholder="Buscar por DTP, foco ou código..."
              className="w-full bg-zinc-950 border border-zinc-800 rounded-xl pl-8 pr-3 py-1.5 text-xs text-white placeholder-zinc-500 focus:outline-none focus:border-cyan-500/50 font-mono"
            />
          </div>
        </div>

        <div className="overflow-x-auto max-h-96 scrollbar-thin scrollbar-thumb-zinc-800">
          <table className="w-full text-left font-mono text-xs text-zinc-300">
            <thead className="border-b border-zinc-800 text-zinc-500 uppercase text-[10px] sticky top-0 bg-zinc-900">
              <tr>
