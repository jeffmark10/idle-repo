...
import { 
  ...
  Compass, Trophy, Filter, Star, Info, 
  Target
} from "lucide-react";
...
const ETERNITY_CHALLENGES_DATA = [
  ...
  },
  {
    ...
    tiers: [
      ...
      { tier: 5, handicap: "Desativado", goal: "e250.000 Score", reward: "+30 Níveis RP Livres", req: "[43/50] DU1 ~187 pós EC10-1" }
    ]
  },
  {
    num: 8,
  ...
  },
  {
    ...
    tiers: [
      ...
      { tier: 4, handicap: "Desativado", goal: "e450.000 Score", reward: "x1.40 Exp GP", req: "[44/50] DU1 ~187 pós EC10-1" },
      { tier: 5, handicap: "Desativado", goal: "e700.000 Score", reward: "x1.50 Exp GP", req: "[45/50] DU1 ~304 pós EC10-2" }
    ]
  },
  {
    num: 10,
    ...
    tiers: [
      { tier: 1, handicap: "Dilatação ^3", goal: "1.000.000 Score", reward: "x10 Ganho de DP", req: "[46/50] DU1 ~150-160 (30 min)" },
      { tier: 2, handicap: "Dilatação ^3", goal: "1e10 Score", reward: "x50 Ganho de DP", req: "[47/50] DU1 ~220-230 (15 min)" },
      { tier: 3, handicap: "Dilatação ^3", goal: "1e100 Score", reward: "x150 Ganho de DP", req: "[48/50] DU1 ~330 (5 min)" },
      { tier: 4, handicap: "Dilatação ^3", goal: "1e308 Score", reward: "x400 Ganho de DP", req: "[49/50] DU1 ~380 (5 min)" },
      { tier: 5, handicap: "Dilatação ^3", goal: "1e1.000 Score", reward: "x1.000 Ganho de DP", req: "[50/50] DU1 ~457 (Instantâneo)" }
    ]
  }
];
