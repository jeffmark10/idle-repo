...
export default function SubNavTabs({ 
  ...
  const activeStyles = {
    ...
    amber: "bg-amber-600 text-white shadow-md shadow-amber-900/40",
  ...
  const activeBadgeStyles = {
    ...
    emerald: "bg-emerald-950/90 text-emerald-200 border-emerald-400/30",
    amber: "bg-amber-950/90 text-amber-200 border-amber-400/30",
